...
enum SocialNetwork {
    ...
    func url() -> SocialNetworkUrl {
        switch self {
        case .Twitter: return SocialNetworkUrl(scheme: "twitter:///dakanik_ksa", page: "https://twitter.com/dakanik_ksa")
        case .SnapChat: return SocialNetworkUrl(scheme: "snapchat://add/dakanik_ksa", page: "https://www.snapchat.com/add/dakanik_ksa")
        case .WhatsApp: return SocialNetworkUrl(scheme: "https://wa.me/0570022024", page: "https://wa.me/0570022024")
        case .Instagram: return SocialNetworkUrl(scheme: "instagram://platform__dakanik", page:"https://www.instagram.com/platform__dakanik")
        }
    }
    func openPage() {
        self.url().openPage()
